...
import { assign, standardizeAny } from '@sentry/utils/object';
...
export class Scope {
  ...
  public setTag(key: string, value: string): Scope {
    this.tags = { ...this.tags, [key]: standardizeAny(value) };
    this.notifyScopeListeners();
    return this;
  }
  ...
  public setExtra(key: string, extra: any): Scope {
    this.extra = { ...this.extra, [key]: standardizeAny(extra) };
    this.notifyScopeListeners();
    return this;
  }
  ...
  public setFingerprint(fingerprint: string[]): Scope {
    this.fingerprint = standardizeAny(fingerprint);
    this.notifyScopeListeners();
    return this;
  }
  ...
  public setLevel(level: Severity): Scope {
    this.level = standardizeAny(level);
    this.notifyScopeListeners();
    return this;
  }
  ...
  public addBreadcrumb(breadcrumb: Breadcrumb, maxBreadcrumbs?: number): void {
    this.breadcrumbs =
      maxBreadcrumbs !== undefined && maxBreadcrumbs >= 0
        ? [...this.breadcrumbs, standardizeAny(breadcrumb)].slice(-maxBreadcrumbs)
        : [...this.breadcrumbs, standardizeAny(breadcrumb)];
    this.notifyScopeListeners();
  }
